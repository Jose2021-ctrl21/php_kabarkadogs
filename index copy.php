      ...
      <div class="carousel-inner carousel-dark-mode" style="z-index:0">
        <div class="carousel-item">
          <img
            ...
            class="d-block w-100"
            alt="ey"
            style="object-fit: contain; height: 38rem"
          />
          <div class="container">
            <div class="carousel-caption text-start">
              <h1 class="fs-1">Adoption can change their life.</h1>
              <p class="opacity-75">
                The KabarkaDogs is a Non-Profit Organization that was formed in 2019 to give abandoned, neglected and stray pets a chance to have a good life.
              </p>
            </div>
          </div>
        </div>
