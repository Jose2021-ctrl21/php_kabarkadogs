...
FROM deceased
INNER JOIN animals ON deceased.animal_id = animals.id WHERE deceased.id = $id;";
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                <div><h2 class="title">View Deceased Animal</h1></div>
            ...
            <div class="col-lg-12">
                ...
                <p><img class="img-fluid" src="../uploads/<?php echo $picture?>" style="height: 150px;"/></p>
                    ...
                    <p class="color-kabarkadogs">Date of death: <?php echo $date_of_death ?></p>
                    <p class="color-kabarkadogs">Cause of death: <?php echo $cause_of_death ?></p>
                    <p class="color-kabarkadogs">Mammal: <?php echo $mammal ?></p>
                    <hr>
                    <div class="d-flex">
                        <div class="action-button">
                            <a href="deceased-animals-edit.php?id=<?php echo $id; ?>" title="Edit"><i class="fa-solid fa-pencil"></i></a>
                        </div>
                        <div class="action-button">
