        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="post" action="_process_edit_donations.php">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-10 col-sm-12">
                                        <input type="date" class="form-control" id="date_of_donation" name="date_of_donation" value="<?php echo $date_of_donation ?>"/>
                                    </div>
                                </div>
                                <div class="mb-3 row">
