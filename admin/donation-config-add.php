    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                <div><h2 class="title">Add account</h1></div>
            </div>
            <div class="col-lg-12">
                <div class="box">
                    <div class="row">
                        <div class="col-lg-12">
                            <form method="post" action="_process_add_config_donation.php" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    <label for="accountImg" class="col-sm-12 col-lg-2 col-form-label">account image: <span class="required">*</span></label>
                                    <div class="col-lg-10 col-sm-12">
                                        <input type="file" class="form-control" id="accountImg" name="accountImg"/>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-10 col-sm-12">
                                        <textarea class="form-control form-control-lg" id="instructions" name="instructions" rows="5"></textarea>
                                    </div>
                                </div>
