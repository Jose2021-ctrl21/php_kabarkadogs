...
$sql = "SELECT deceased.*, animals.name, animals.age, animals.breed, animals.sex, animals.weight, animals.color, animals.mammal, animals.picture AS picture
FROM deceased
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between">
                <div><h2 class="title">Deceased Animals</h1></div>
                <div class="d-flex align-items-center"><a class="btn btn-kabarkadogs" href="deceased-animals-add.php"><i class="fa-solid fa-plus"></i>&nbsp;&nbsp;&nbsp;Add Animal</a></div>
            </div>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="action-button">
                                                            <a href="deceased-animals-view.php?id=<?php echo $row['id']?>" title="View" class="btn btn-primary"><i class="fa-solid fa-eye"></i></a>
                                                        </div>
                                                        <div class="action-button">
                                                            <a href="deceased-animals-edit.php?id=<?php echo $row['id']?>" title="Edit"><i class="fa-solid fa-pencil"></i></a>
                                                        </div>
                                                        <div class="action-button">
                                                            <button class="border-0 color-red delete-animal" data-animal-id="<?php echo $row['id']; ?>" title="Delete" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    confirmDeleteButton.addEventListener("click", function () {
        ...
        if (animalIdToDelete !== null) {
            ...
            xhr.open("POST", "_process_delete_deceased_animals.php", true);
