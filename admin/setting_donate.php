...
//FOR ADOPTION FEE
$sql = "SELECT * FROM donation_how_can_we_help";
...
lists.id AS id
FROM lists 
JOIN donation_how_can_we_help AS hcwp
ON hcwp.id = lists.how_can_we_help_id";
                    ...
                    ?>
                       <div class="col-lg-12 shadow pb-5"> 
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <center><h2 class="title">How can we help?</h2></center>
                            ...
                            <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <form method="POST" action="_process_edit_hcwp.php" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                            ...
                                                            <a href="javascript:void(0);" onclick="triggerFileInput()">
                                                                <img src="../uploads/<?php echo $row['img_1']; ?>" alt="Current Image" style="max-width: 100%; height: auto;">
                                                            </a>
                                                            <input type="hidden" name="existing-image" value="<?php echo $row['img_1']; ?>">
                                                            <?php else: ?>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <input type="text" id="id" name="id" placeholder="id" class=" form-control mb-3" value="<?php echo $row['id']?>">
                                                        <label for="small-title"><b>Small title:</b></label>
                                                        <input type="text" id="small-title" name="small-title" placeholder="small-title" class=" form-control mb-3" value="<?php echo $row['small_title']?>">
                                                       
                                                        <label for="title"><b>Title:</b></label>
                                                        <input type="text" id="title" name="title" placeholder="title" class=" form-control mb-3" value="<?php echo $row['title']?>">

                                                        <label for="description"><b>Title description:</b></label>
                                                        <textarea type="text" id="description" name="description" placeholder="description" class=" form-control mb-3" cols="15" rows="5"><?php echo $row['description']?></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="">
                                                           <!-- LIST INPUT -->
                                                            ...
                                                            <ul id="listsContainer" class="list-group mt-3 scroll-y">
                                                                ...
                                                                <?php foreach($rows_list as $row_l): ?>
                                                                    <!-- List item generated from PHP loop -->
                                                                    <li class="list-group-item d-flex justify-content-between align-items-center list-remove" id="list-id" value="<?php echo $row_l['id']?>">
                                                                        <?php echo $row_l['description']; ?>
       ...
       // Get references to elements
        ...
        addButton.addEventListener('click', function() {
            ...
            if (add_id !== null && listItemText.length > 0) {
                ...
                xhr.open("POST", "_process_add_hcwp_lists.php", true);
...
function removeListItem(button) {
    ...
    if (id !== null) {
        var xhr = new XMLHttpRequest();
        xhr.open("POST", "_process_delete_hcwp_lists.php", true);
        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
