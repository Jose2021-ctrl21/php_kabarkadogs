...
<?php require('./layout/header.php') ?>
    ...
    <div class="container">
        <div class="p-5 text-center rounded-3 mt-5">
            <h1 class="color-kabarkadogs fw-bold hero-title position-relative display-3">Rescue Stories</h1>
                  ...
                  <div class="row featurette">
                    <div class="col-md-5">
                      ...
                      <p class="lead color-kabarkadogs">
                        <span class="fw-semibold">Rescued Date: </span> <?php echo $row['rescued_date']; ?>
                      </p>
                      <p class="lead color-kabarkadogs">
                        <span class="fw-semibold">Rescued Location: </span> <?php echo $row['rescued_location']; ?>
                      </p>
                      <p class="lead color-kabarkadogs">
                    ...
                    <div class="col-md-7 d-flex justify-content-end">
                      <?php
                      $imgSrc = !empty($row['picture']) ? "uploads/" . $row['picture'] : "assets/images/blank_dog_img.jpg";
                      ?>
                      <img
                          src="<?php echo $imgSrc; ?>"
                          alt="dog"
